/*
    1. Obtener string
    2. Ordenar cadena en postfijo
    3. Obtener dos variables y un operador para evaluar
    4. Mostrar tabla de verdad de variables activadas
    5. Mostrar tabla de verdad de evaluaciones
 */
package Modelo;
...
public class Valores {
    ...
    protected static final ArrayList<Character> arrUno = new ArrayList<>();
    protected static final ArrayList<Character> arrDos = new ArrayList<>();
    protected static final ArrayList<Character> arrTres = new ArrayList<>();
    protected static final ArrayList<Character> arrCuatro = new ArrayList<>();
    protected static final ArrayList<Character> arrCinco = new ArrayList<>();
    protected static final ArrayList<Character> arrSeis = new ArrayList<>();
    protected static Object[] vectorVariables;
